...
class _StatusHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if algo_requested and (paper_requested or confirmed):
            self.tracker.algo_enabled = algo_requested
            log.info("⚙️  algo_enabled set to %s in memory (not saved to file)", algo_requested)
