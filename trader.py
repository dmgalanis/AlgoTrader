...
class AlgoEngine:
    ...
    async def run(self):
        ...
        async def position_monitor():
            ...
            Runs under the engine lock so it cannot mutate self.state while
            execute_entry is mid-flight (which would cause a KeyError on the
            position dict and silently skip stop/TP placement).
            """
